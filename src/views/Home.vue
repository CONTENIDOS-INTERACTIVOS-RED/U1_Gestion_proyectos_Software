        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde la planificación hasta la entrega final, cada proyecto de software requiere una estructura clara, liderazgo efectivo y aplicación de buenas prácticas. En esta primera unidad, se abordan los fundamentos claves de la gestión de proyectos, incluyendo el ciclo de vida, el rol del gerente de proyectos y los conceptos esenciales del estándar PMBOK. A través de esta exploración, los estudiantes comprenderán cómo gestionar iniciativas tecnológicas de manera eficiente, adaptándose a metodologías tradicionales y ágiles, según el contexto. 
              
              p #[b ¡Prepárese para liderar con éxito sus proyectos de software, en escenarios dinámicos y colaborativos!]
